    ...
    <label>
        <form @submit.prevent="handleSubmit">
            ...
            <label class="input input-bordered flex items-center gap-2 mb-2" :class="{'input-error': props.usrOrEmailError}">
                ...
                <input type="email" placeholder="Correo electrónico" v-model.trim="form.email" class="grow" required />
            </label>
            ...
            <label class="input input-bordered flex items-center gap-2 mb-2">
                ...
                <input type="tel" placeholder="Teléfono" v-model="form.phone" class="grow" />
        ...
        <span class="label-text-alt">¿Ya tienes cuenta? <RouterLink to="/login">Inicia Sesión</RouterLink></span>
    </label>
</template>